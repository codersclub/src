...
print<<ForumHTML;
<B>
<FONT SIZE="1" FACE="Verdana, Arial">You can easily assign/change forum names, descriptions, and properties through this control panel.  The Freeware Version of the UBB only supports 9 forums.  Note that the <A HREF="http://www.ultimatebb.com" target=_blank>licensed version</A> offers unlimited forums and many more configuration options (including private forums)!</FONT>
<P>
</B>
<FORM ACTION="cpanel3.pl" METHOD="POST" NAME="THEFORM">
<center>
...
<TR bgcolor="#C7C6BA">
<TD><FONT SIZE="1" FACE="Verdana, Arial"><B>Name:</B></FONT></td>
...
<TR bgcolor="#C7C6BA"><TD><FONT SIZE="1" FACE="Verdana, Arial"><B>HTML Allowed?</B></FONT></td><TD><FONT SIZE="1" FACE="Verdana, Arial"><B><INPUT TYPE="RADIO" NAME="HTML||$ForumCounter" VALUE="is" $HTMLOn> Yes &nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="HTML||$ForumCounter" VALUE="is not" $HTMLOff> No</B></FONT></td></tr>
...
<TR bgcolor="#C7C6BA" ><TD><FONT SIZE="1" FACE="Verdana, Arial"><B>UBB Code Images Allowed?</B></FONT></td><TD><FONT SIZE="1" FACE="Verdana, Arial"><B><INPUT TYPE="RADIO" NAME="UBBImages||$ForumCounter" VALUE="ON" $UBBImagesOn> Yes &nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="UBBImages||$ForumCounter" VALUE="OFF" $UBBImagesOff> No</B></FONT></td></tr>
<TR bgcolor="#C7C6BA"><TD><FONT SIZE="1" FACE="Verdana, Arial"><B>Description:</B></FONT></td><td><TEXTAREA NAME="Description||$ForumCounter" ROWS=3 COLS=30 wrap="VIRTUAL">$thisforum[2]</TEXTAREA></td></tr>
ForumGuts
} #for forumline
...
<P>
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#000000"><A HREF="http://www.ultimatebb.com">Ultimate Bulletin Board</A>, &copy; Infopop Corporation, 1998 - 2000.</FONT>
</CENTER></font>
</BODY>
</HTML>
BottomForumHTML
