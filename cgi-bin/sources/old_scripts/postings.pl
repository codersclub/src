...
&Forward("$NonCGIURL/Forum$number/HTML/$ThreadNo.html", "Уважаемый, $UserName!  Через две секунды форум автоматически вернёт Вас в текущий топик.");
...
&Forward("$CGIURL/forumdisplay.pl?action=topics&forum=$ForumCoded&number=$number&DaysPrune=$DaysPrune", "Thanks for posting your message, $UserName!  We are now taking you back automatically to the topic list for $Forum.");
...
sub ReplyFormHTML {
print <<REPLYFORM;
<HTML><HEAD><TITLE>$BBName - Ответ на вопрос</TITLE>
</HEAD>
...
<B>
Раздел: <FONT COLOR="#800080">$Forum </FONT>
<BR>
Тема: <FONT COLOR="#800080">$TopicSubject</FONT>
</B>
</FONT>
</td></tr></table>
<CENTER>$LWADisclaimer
<p><FONT SIZE="2" FACE="Verdana, Arial" COLOR="#800080">
Внимание: Чтобы написать сообщение, необходимо быть зарегистрированным пользователем. <br>
Зарегистрироваться <A HREF="$CGIURL/Ultimate.pl?action=agree">здесь</A>.  Регистрация бесплатная :)
</FONT>
</CENTER>
<ul>
<FORM ACTION="postings.pl" NAME="REPLIER" METHOD="POST">
<table border=0>
<tr><td NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000000"><B>Ваше Имя:</B></FONT></td>
<td>
...
<tr>
<td NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000000"><B>Ваш Пароль:</B></FONT></td>
<td><INPUT TYPE="PASSWORD" NAME="Password" VALUE="" SIZE=13 MAXLENGTH=13>
</td></tr>
<TR><TD valign=top NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial" COLOR="#000000"><B>Фраза:</B></FONT>
<p><BR>
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#800080">
$ISHTML<BR>
$ISUBB<BR>
...
<P>
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#FF0000">*If HTML and/or <A HREF="$NonCGIURL/ubbcode.html" target=_new>UBB Code</A> are enabled, this means you can use use HTML and/or UBB Code in your message.</FONT>
</center>
<br></ul><center>
REPLYFORM
} # end ReplyFormHTML
...
<B>Новое сообщение в раздел форума:<br>&nbsp;&nbsp;&nbsp;<FONT COLOR="#000080">$Forum</FONT></FONT></B>
</td></tr></table>
<CENTER>
<p><FONT SIZE="2" FACE="Verdana, Arial" COLOR="#800080">
Внимание: Чтобы написать сообщение, необходимо быть зарегистрированным пользователем. <br>
...
<UL><FORM ACTION="postings.pl" METHOD="POST" NAME="PostTopic">
<table border=0>
<tr>
<td NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial"><B>Ваше имя:</B></FONT></td><td><INPUT TYPE="TEXT" NAME="UserName" SIZE=25 MAXLENGTH=25>
</td></tr>
<tr>
<td NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial"><B>Пароль:</B></FONT></td><td><INPUT TYPE="PASSWORD" NAME="Password" SIZE=13 MAXLENGTH=13></td></tr>
$LWAField
<TR>
<td NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial"><B>Тема:</B></FONT></td>
<td><INPUT TYPE="TEXT" NAME="TopicSubject" VALUE="" SIZE=40 MAXLENGTH=85></td></tr>
<tr><td valign=top NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial"><B>Фраза:</B></FONT>
<p><BR>
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#800080">
$ISHTML<BR>
...
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#800080">*If HTML and/or <A HREF="$NonCGIURL/ubbcode.html" target=_new>UBB Code</A> are enabled, this means you can use use HTML and/or UBB Code in your message.</FONT>
<P>
<center>
...
<FONT SIZE="1" face="Verdana, Arial" color="#000080"><B>Name</B></FONT>
</TD>
<TD valign=top>
<FONT SIZE="1" face="Verdana, Arial" color="#000080"><B>Post</B></FONT>
</TD>
</TR>
otherHTML
}  
...
<tr bgcolor="$AlternateColor">
	...
	<FONT SIZE="2" face="Verdana, Arial"><B>$Author</B></FONT>
</td>
<TD>
...
if ($thisforum[4] eq "is") {
	...
	$ISHTML = "*HTML выключен";
	$HTMLAllowed = "no";
}
 
if ($thisforum[5] eq "is") {
	$ISUBB = "*UBB коды включены";
	$UBBAllowed = "yes";
}  else {
	$ISUBB = "*UBB коды выключены";
	$UBBAllowed = "no";
}
