...
print<<NEXT;
<HTML><HEAD>
<meta http-equiv="Refresh" content="2; URL=$CGIURL/cpanel2.pl?action=ContinueUpdate&number=$number&TotalForums=$TotalForums&UserName=$UserName&Password=$Password&StartWith=$StartWith">
</head>
<BODY bgcolor=#FFFFFF>
<center>
...
$ThisThread = qq(<HTML><HEAD><TITLE>$TopicSubject - $BBName</title><META HTTP-EQUIV="Pragma" CONTENT="no-cache"></head> <BODY bgcolor="#FFFFFF"   text="#000000" link="#000080" vlink="#800080">
...
<BR><center><FONT SIZE="1" FACE="Verdana, Arial" COLOR="#000080"></FONT></center>
</FONT>
</td>
<td valign=top NOWRAP>
<FONT SIZE="1" FACE="Verdana, Arial">
<IMG SRC="$NonCGIURL/open.gif" WIDTH=15 HEIGHT=11 BORDER=0>&nbsp;&nbsp;<A HREF="$CGIURL/Ultimate.pl?action=intro">$BBName</A>
<br>
<IMG SRC="$NonCGIURL/tline.gif\" WIDTH=12 HEIGHT=12 BORDER=0><IMG SRC="$NonCGIURL/open.gif" WIDTH=15 HEIGHT=11 BORDER=0>&nbsp;&nbsp;<A HREF="$CGIURL/forumdisplay.pl?action=topics&forum=$ForumCoded&number=$number">$Forum</A>
<br>
...
<A HREF="$CGIURL/postings.pl?action=newtopic&number=$number&forum=$ForumCoded"><b>СПРОСИТЬ</b></A>&nbsp;&nbsp;<A HREF="$CGIURL/postings.pl?action=reply&forum=$ForumCoded&number=$number&topic=$ThreadFile&TopicSubject=$SubjectCoded"><b>ОТВЕТИТЬ</b></A></FONT>
<BR>
<A HREF=\"$CGIURL/ubbmisc.pl?action=editbio&Browser=$Browser&DaysPrune=$DaysPrune"><ACRONYM TITLE=\"Click here to edit your profile.\">профайл</ACRONYM></A> | <A HREF="$CGIURL/Ultimate.pl?action=agree"><ACRONYM TITLE=\"Зарегистрироваться необходимо!">регистрация</ACRONYM></A>  | <A HREF="$NonCGIURL/faq.html" target=_blank><ACRONYM TITLE=\"Frequently Asked Questions">faq</ACRONYM></A>
</center>
</td></tr></table>);
...
$EmailString = qq(&nbsp;&nbsp;<A HREF="$CGIURL/Ultimate.pl?action=email&ToWhom=$UNCoded" target=_new><IMG SRC="$NonCGIURL/email.gif" BORDER=0 WIDTH=24 HEIGHT=11 ALT="Click Here to Email $statarray[3]"></A>&nbsp;&nbsp;);
} 	

$ThisThread .= qq(<center><table width=95% border=0 cellpadding=5><TR bgcolor="#d5e6e1">
<TD valign=middle width=18%>
<FONT SIZE="1" face="Verdana, Arial" color="#000080"><B>Автор</B></FONT>
</TD>
<TD valign=middle>
<FONT SIZE="1" face="Verdana, Arial" color="$000080"><B>Тема:&nbsp;&nbsp; $TopicSubject</B></FONT>
</TD>
</TR>
<tr bgcolor="#F7F7F7">
<td NOWRAP width=18% valign=top>
<FONT SIZE="2" face="Verdana, Arial"><B>$statarray[3]</B></FONT></td>
</TD>
<td valign=top>
<IMG SRC="$NonCGIURL/posticon.gif" BORDER=0>
<FONT SIZE="2" FACE="Verdana, Arial">
<FONT SIZE="1" color="#000080" face="Verdana, Arial">опубликован $ThisDate $FormatTime $TimeZone&nbsp;&nbsp;&nbsp;<A HREF="$CGIURL/ubbmisc.pl?action=getbio&UserName=$UNCoded" target=_new><IMG SRC="$NonCGIURL/profile.gif" WIDTH=22 HEIGHT=11 BORDER=0 ALT="Click Here to See the Profile for $statarray[3]"></A> $EmailString 
...
$EmailString = qq(&nbsp;&nbsp;<A HREF="$CGIURL/Ultimate.pl?action=email&ToWhom=$UserNameCoded" target=_new><IMG SRC="$NonCGIURL/email.gif" BORDER=0 WIDTH=24 HEIGHT=11 ALT="Click Here to Email $thisline[2]"></A>&nbsp;&nbsp;);
} 	

$ThisThread .= qq(<tr bgcolor="$AlternateColor">
	<TD width=18% valign=top>
	<FONT SIZE="2" face="Verdana, Arial"><B>$thisline[2]</B></FONT>
</td>
<TD>
<IMG SRC="$NonCGIURL/posticon.gif" BORDER=0>
<FONT SIZE="2" FACE="Verdana, Arial">
<FONT SIZE="1" color="$000080" face="Verdana, Arial">опубликован $ThisDate $FormatTime $TimeZone &nbsp;&nbsp;&nbsp;
<A HREF="$CGIURL/ubbmisc.pl?action=getbio&UserName=$UserNameCoded" target=_new><IMG SRC="$NonCGIURL/profile.gif" WIDTH=22 HEIGHT=11 BORDER=0 ALT="Click Here to See the Profile for $thisline[2]"></A>$EmailString &nbsp;&nbsp;
</FONT><HR>$ReplyText</FONT></td></tr>);

#rotate thru alt colors
if ($AlternateColor eq "#F7F7F7") {
	$AlternateColor = "#dedfdf";
	}  else {
...
$ThisThread .= qq(</table></center><p><table border=0 width=95%><tr><td><CENTER><A HREF="$CGIURL/postings.pl?action=newtopic&number=$number&forum=$ForumCoded"><b>СПРОСИТЬ</b></A>&nbsp;&nbsp;<A HREF="$CGIURL/postings.pl?action=reply&forum=$ForumCoded&number=$number&topic=$ThreadFile&TopicSubject=$SubjectCoded"><b>ОТВЕТИТЬ</b></A></CENTER></TD>
<td align=right NOWRAP>
<FONT SIZE="2" FACE="Verdana, Arial">
<FORM ACTION="$CGIURL/forumdisplay.pl" METHOD="POST">
...
$ThisThread .= qq(</SELECT><INPUT TYPE="SUBMIT" NAME="SUBMIT" VALUE="Вперёд"></FORM></FONT></TD></tr></TABLE>
<CENTER><br><B><FONT SIZE="2" FACE="Verdana, Arial">
<A HREF="mailto:$BBEmail">E-mail</A> | <A HREF="$HomePageURL">$MyHomePage</A>
</B></FONT>
<P>

<p><FONT COLOR="#000000" size="1" FACE="Verdana, Arial">
<P>
Powered by: <A HREF="http://www.ultimatebb.com">Ultimate Bulletin Board</A>, Freeware Version 5.10a<BR>Purchase our Licensed Version- which adds many more features! <BR>&copy; Infopop Corporation (formerly <A HREF="http://www.madronapark.com">Madrona Park, Inc.</A>), 1998 - 2000.<br><br>
