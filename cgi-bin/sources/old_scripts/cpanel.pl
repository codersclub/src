...
<FORM ACTION="cpanel2.pl" METHOD="POST" NAME="THEFORM">
...
<BR>
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#008080">Note: "DOCUMENT_ROOT" shows your absolute path to your root web directory.  "SCRIPT_FILENAME" shows you absolute path of your CGI directory.  If your SCRIPT_FILENAME shows "/www/whatever/whatever/cgi-bin/cpanel.pl", your Absolute Path variable for your CGI directory would be "/www/whatever/whatever/cgi-bin".</FONT><P>
TOP
for $key (keys(%ENV)) {
...
<br><br>
<CENTER><B><A HREF="$NonCGIURL/controlpanel.html">Control Panel</A>  |  <A HREF="$CGIURL/Ultimate.pl?action=intro">Bulletin Board</A></B>
...
<p>
To configure your bulletin board variables for the first time, <A HREF="cpanel2.pl?action=DoGenVars">click here</A>.
<P>
