...
hotlog_r+="&wh="+hotlog_s.width+'x'+hotlog_s.height+"&px="+((hotlog_n_n==0)?hotlog_s.colorDepth:hotlog_s.pixelDepth)</script>
...
<A HREF="$ForwardURL">Нажмите здесь, если Вы не хотите ждать так долго (либо если Ваш браузер не перенаправляет Вас автоматически).</A>
</B><br><br>
</FONT>
</ul>
</body></html>
