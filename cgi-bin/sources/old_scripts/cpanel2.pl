...
print<<THIS;
To check your environmental variables, <A HREF="cpanel.pl?action=env">click here</A>.

<P>
<BR>
<U><B><FONT SIZE="4" FACE="COurier New" COLOR="#800000"><A NAME="GENVAR">General Settings</A></FONT></B></U>
<P>
<FORM ACTION="cpanel2.pl" NAME="THEFORM" METHOD="POST">
...
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#000080">This path should end in /Members (as in "/usr/home/yourdomain/www/cgi-bin/Members")</FONT>
</td>
<td width=50% valign=top>
...
<FONT SIZE="1" FACE="Verdana, Arial" COLOR="#000080">European Format is DD-MM-YR, while US format is MM-DD-YR.</FONT>
</td>
<td width=50%>
...
<FORM ACTION="cpanel2.pl" METHOD="POST" NAME="PERMISS">
...
<td><FONT SIZE="1" FACE="Verdana, Arial"><A HREF="cpanel.pl?action=getbio4admin&UserName=$UNCoded">$searchrow[0]</A><BR>$DateReg</font></td>
...
<A HREF="$CGIURL/Ultimate.pl?action=intro">Bulletin Board</A>
</ul>
</B></FONT>
</BODY></HTML>
Error
