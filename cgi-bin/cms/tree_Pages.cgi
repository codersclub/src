...
print "--></script><script language=\"javascript\">
      ...
      function edit()
      {
        if (!cur_type || cur_cid==0) {
          ...
          parent.right.location = 'edit_Page.cgi?action=edit&ID='+cur_cid;
        } else if (cur_type == 'item') {
          parent.right.location = 'edit_Page.cgi?action=editID='+cur_cid;
        }
      }
      
      function reload()
      {
            window.location='?page=tree_Pages;items_fid=0';
      }
...
//          alert('???????? ??????, ? ??????? ????????? ?????????');
//        }  else {
          parent.right.location = 'edit_Page.cgi?action=new&ParentID='+cur_cid;
//        }
      }
      ...
      function new_news()
      {
        if (!cur_type || cur_type == 'title' || cur_cid == 0) {
          ...
          parent.right.location = '?page=edit_Page;ParentID='+cur_cid;
        }
      };
      ...
      function show_news()
      {
        if (!cur_type || cur_type == 'title' || cur_cid == 0 ) {
          ...
          parent.left.location = '?page=tree_Pages;items_fid='+cur_cid;
          parent.right.location = '?page=list_Pages;ParentID='+cur_cid;
        }
      };
      ...
      function delete_item()
      {
        if (!cur_type || cur_cid==0) {
          ...
          if (cur_type == 'folder') {
            parent.right.location = 'list_Pages.cgi?action=delete&ID='+cur_cid;
          } else if (cur_type == 'item') {
            parent.right.location = 'list_Pages.cgi?action=delete&ID='+cur_cid;
          }
        }	
...
<td><img src=\"$img_dir/pix.gif\" width=\"5\" height=\"14\" border=\"0\"></td>
<td><font color=\"white\" class=\"smaller\">Нов.страница</font></td>
<td><img src=\"$img_dir/pix.gif\" width=\"5\" height=\"14\" border=\"0\"></td>
</tr></table></a></td>
<td bgcolor=\"black\"><img src=\"$img_dir/pix.gif\" width=\"1\" height=\"1\" border=\"0\"></td>
</tr>
...
<td><a style=\"cursor: hand\" onclick=\"edit()\"><img src=\"$img_dir/ico_properties.gif\" alt=\"Редактировать\" width=\"16\" height=\"13\" border=\"0\"></a></td>
...
<td><img src=\"$img_dir/pix.gif\" width=\"7\" height=\"14\" border=\"0\"></td>
<td><a style=\"cursor: hand\" onclick=\"javascript:delete_item()\"><img src=\"$img_dir/ico_del.gif\" alt=\"Удалить\" width=\"16\" height=\"16\" border=\"0\"></a></td>
<td><img src=\"$img_dir/pix.gif\" width=\"7\" height=\"14\" border=\"0\"></td>
<td><img src=\"$img_dir/dash_small.gif\" alt=\"\" width=\"2\" height=\"19\" border=\"0\"></td>
<td><img src=\"$img_dir/pix.gif\" width=\"5\" height=\"14\" border=\"0\"></td>
...
<td><font color=\"white\" class=\"big\">Страницы</font></td>
</tr></table></td>
<td background=\"$img_dir/bar_rightbg.gif\"><img src=\"$img_dir/pix.gif\" alt=\"\" width=\"5\" height=\"14\" border=\"0\"></td>
</tr></table>
<table width=\"222\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr>
