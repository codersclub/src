...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=windows-1251" /> <!-- vot -->
  ...
  <link rel="stylesheet" media="screen" type="text/css" href="<?php echo DOKU_TPL?>copyFrom.css" />
...
<div class="dokuwiki">
  ...
  <div class="page">
    ...
    <!-- wikipage stop -->
      ...
      <?php @include(dirname(__FILE__).'/copyFrom.php') ?>
