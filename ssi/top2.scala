...
.title {background-color: #A5E4A7; TEXT-DECORATION: none; FONT-WEIGHT: bold; FONT-FAMILY: Arial,Verdana,Tahoma,sans-serif; FONT-SIZE: 12pt}
...
<form action="/cgi-bin/sources/search/search.cgi" method="get" align="left">
  ...
  cellspacing="0" width="750" align="center">
    <tr>
      <td valign="top"><table border="0" cellpadding="0" cellspacing="0" width="287">
        <tr>
...
<!-- БАННЕР -->
<a target=_blank href="http://bs.boro.ru/click.php?bs=581"><img border=0 width=468 height=60 src="/img/scala.gif"></a>
<!-- БАННЕР -->
