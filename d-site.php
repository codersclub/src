...
//define( 'ROOT_PATH', "c:/wwwroot/forum.sources.ru/" );
//define( 'ROOT_PATH', "/var/www/htdocs/forum.sources.ru/" );
...
$ibforums->lang = $std->load_words($ibforums->lang, 'lang_csite', $ibforums->lang_id );
 ...
 //$ibforums->vars['dynamiclite'] = "http://sources/site/";
...
require ROOT_PATH."sources/dynamiclite/mod_fav.php";
require ROOT_PATH."sources/dynamiclite/mod_rep.php";
