...
///* vot */ print "TOC here <br>";


// vot
//   print "\$xhtml_renderer=".$xhtml_renderer."<br>";
//   $toc_html = $xhtml_renderer->render_TOC();

//foreach($xhtml_renderer as $k=>$v) {
//echo $k."=".$v."<br>";
//}
//   print "toc_html=".$toc_html."<hr>";

//   print $html."<hr>";


//   print "Right banner here.";
...
function html_search(){
  ...
  print '<br /></div>';
  print '<script type="text/javascript" charset="'.$conf['charset'].'">';
...
?>
  ...
  <form id="dw__editform" method="post" action="<?php echo script()?>" accept-charset="<?php echo $lang['encoding']?>"><div class="no">
     <div class="toolbar">
        ...
        <?php if($wr){?>
        <script type="text/javascript" charset="<?php echo $conf['charset']?>">
