...
//$ret .= $file." exists, rev=".$rev;
    }elseif($excuse){
      $ret = p_locale_xhtml('norev');
//$ret .= $file." exists norev";
    }
  }else{
    if(@file_exists($file)){
      $ret = p_cached_xhtml($file);
//$ret .= $file." exists - cached";
    }elseif($excuse){
      $ret = p_locale_xhtml('newpage');
//$ret .= $file." not exists - newpage";
    }
  }
...
//  $Renderer->toc_html = $Renderer->render_TOC();

//echo "p_render() started: ".$Renderer->toc_html."<hr>";
