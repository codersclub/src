...
function tpl_metaheaders($alt=true){
  ...
  if($js_edit && $js_write){
    ptln('<script type="text/javascript" charset="'.$conf['charset'].'">',$it);
  ...
  ptln('<script type="text/javascript" charset="'.$conf['charset'].'" src="'.
...
function tpl_searchform($ajax=true,$autocomplete=true){
  ...
  print '<form action="'.wl().'" accept-charset="'.$conf['charset'].'" class="search" id="dw__search"><div class="no">';
