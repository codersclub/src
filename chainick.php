...
require ROOT_PATH."sources/cms/core/table_linker.php";
require ROOT_PATH."sources/dynamiclite/navigation.php";
require ROOT_PATH."/sources/dynamiclite/online_stats.php";
require ROOT_PATH."/sources/cms/core/users.php";
