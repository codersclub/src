    ...
    <table border="0" align="center" width=400 cellspacing="0" cellpadding=4 bgcolor="#eeeef0">
      ...
      <tr>
        ...
        <td><input type="text" size="32" maxlength="32"
          ...
          <img src='calendar/calendar.gif' id='calendar_start_time' style='cursor: pointer; border: 0px;' title='Календарь'>
...
<P>
   ...
   <UL type="square">
   <LI><a target="_blank" href="http://webmoney.ru/rus/cooperation/exchange/onlinexchange/index.shtml">Шлюзы ввода/вывода средств между WebMoney Transfer и другими системами</a></LI>
   <LI><a target="_blank" href="http://top.owebmoney.ru/index.php?all=1&cid=1">Рейтинг обменных пунктов на owebmoney.ru</a></LI>
   <LI><a target="_blank" href="http://obmenniki.com/">Лучшие обменники. Мониторинг обменных пунктов. Обмен всех валют</a></LI>
   <LI><a target="_blank" href="http://cursov.net/">Мониторинг автоматических обменных пунктов. Обмен Яндекс.деньги, webmoney - wmz, wmr и прочих систем.</a></LI>
   </UL>
</P>
...
<P>
   ...
   <LI><a target="_blank" href="https://money.yandex.ru/prepaid.xml">Все способы пополнения кошелька Яндекс.деньги</a></LI>
   ...
   <LI><a target="_blank" href="http://geo.webmoney.ru/aspx/GeoMain.aspx">Территория WebMoney - перечень обменных пунктов в 57 странах мира</a></LI>
   </UL>
</P>
